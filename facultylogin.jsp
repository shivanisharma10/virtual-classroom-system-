...
<center> <h3 style="background-color: pink;">FACULTY LOGIN FORM</h3></center>
...
<tr><td colspan=2><font face="verdana,arial" size=-1>Not member yet? Click <a href="facreg.jsp"><input type="button" value="here" /></a>to register.</font></td></tr>
</TABLE>
</TD>
<TD>
</table>
...
String sql="select use from faculty where use='"+str1+"' and pass='"+str2+"'";
...
%>
<jsp:forward page="facultyhome.html" />
<%
}
else
