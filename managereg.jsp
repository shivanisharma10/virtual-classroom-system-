...
<form action="managereg.jsp" method="post">
    <table>
        <tr>
        ...
        <tr>
            <td>Phone no :</td>
            <td><input type="text" name="ph_no" required  /><font style="color:red">maximum 10 digit</font></td>
        </tr>
...
if(i>0)
out.println("Thank you for register ! Please <a href='managelogin.jsp'>Login</a> to continue.");
}
catch(Exception e)
{
System.out.print(e);
