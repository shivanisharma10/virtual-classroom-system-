...
<body>
<center>
<form action="delfa.jsp" method="post">
    <table>
         <tr>
             <td>Faculty ID:</td>
...
int i=st.executeUpdate("delete from faculty where use= '"+use+"'");
if(i>0)
out.println("<br><center>DELETED SUCCESSFULLY!!! Please<br> <a href='FACULTYVIEW_AD.jsp'>CLICK</a> to view.</center>");
}
catch(Exception e)
{
System.out.print(e);
