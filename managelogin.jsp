...
<body background="ssimg.jpg" > 
 <center> <h3 style="background-color: pink;">MANAGEMENT LOGIN FORM</h3></center>
...
<TR>
<TD>
<tr><td> <font face="verdana,arial" size=-1> Login_Type:</font></td> <td><select name="type"><option value="management">management</option></select></td></tr> 
...
<tr><td colspan=2><font face="verdana,arial" size=-1>Not member yet? Click <a href="managereg.jsp"><input type="button" value="here" /></a>to register.</font></td></tr>
</TABLE>
</TD>
<TD>
</table>
...
String sql="select use from management where use='"+str1+"' and pass='"+str2+"'";
...
%>
<jsp:forward page="managehome.html" />
<%
}
else
