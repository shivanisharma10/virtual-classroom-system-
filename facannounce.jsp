...
<td valign="center">
<center>
<h3><pre>  Announcement to Faculty</pre></h3>
<form name="f1" action="facannounce.jsp" method="post">
...
int i=st.executeUpdate("insert into announcementf(announcements) values('"+use+"')");
out.println("<br>Thank you for announcements ! Please<br> <a href='viewfacannounce.jsp'>Click</a> to continue.");
}
catch(Exception e)
{
System.out.print(e);
